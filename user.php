...
?>
    <div class="heading" >
        <h1>Users</h1>
        <img src="user.png" alt="#" id="image" style="height: 70px; width: 70px; margin-top: -25pt; margin-right: 25px;">
    </div>
    <br>
    <div class="container">
        <table>
            <thead>
                <tr>
                    ...
                    <th scope="col" class="text-center py-2">USER</th>
                            ...
                            <a href="transfermoney.php? id=<?php echo $rows['id'] ;?>">
                                <button class="button">
                                    <span class="button__text">
                                        <span>T</span><span>r</span>a</span><span>n</span><span>s</span><span>a</span><span>c</span><span>t</span>
                                    </span>
